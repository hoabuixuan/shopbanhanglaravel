          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ URL::to('/delete-category-product/'.$cate_pro->category_id) }}" onclick="return confirm('Bạn có chắc muốn xóa danh mục này?')" class="active styling-eidt" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></i></a>
                </td>
            </tr>
              @endforeach
